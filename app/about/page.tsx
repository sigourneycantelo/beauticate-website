        ...
        <section className="max-w-6xl mx-auto px-6 pt-8 pb-12 md:grid md:grid-cols-[minmax(0,440px)_1fr] md:gap-16 items-start">
          ...
          <div>
            ...
            <div className="font-serif text-base text-charcoal/80 leading-relaxed space-y-4">
              ...
              <p>That philosophy led to <Link href="/podcast" className="text-wine hover:text-charcoal transition-colors">Beautiful Inside</Link>, a video podcast filmed in the homes and spaces of people we admire, exploring healing, mental health and what lies beneath the lives we present to the world.</p>
              <p>And now to the <Link href="/shop" className="text-wine hover:text-charcoal transition-colors">Beauticate Shop</Link>, our curated edit of the products we actually use, love and recommend. It&apos;s in its testing/beta stage now and we&apos;d love you to be among the first to explore (and give us your feedback). No noise, no fillers. Just the things genuinely worth your time and money.</p>
