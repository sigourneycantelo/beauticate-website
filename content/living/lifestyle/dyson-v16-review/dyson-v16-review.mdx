...
**Q: What makes the Dyson V16 different from other cordless vacuums?**
A: The V16 has a green laser that reveals dust invisible to the naked eye, plus an LCD screen that shows particle readings in real time and changes from red to green as the floor gets cleaner. The combination of visible feedback and intelligent power adjustment makes the cleaning process feel genuinely satisfying rather than a chore.

**Q: Does the Dyson V16 handle long hair without tangling?**
A: Yes. The V16 uses two rotating conical brush bars that guide hair up to 25 inches straight into the bin, eliminating the wrapping and cutting that makes cleaning most vacuum heads so unpleasant. The CleanCompaktor bin also compresses dust as you go and holds up to 30 days' worth before needing emptying.

**Q: Can the Dyson V16 mop floors as well as vacuum?**
A: The V16 Submarine model includes a wet roller head that washes hard floors while removing grime and spills, removing the need for a separate mop. There is also an extra hydration mode for tougher stuck-on mess.

**Q: How long does the Dyson V16 battery last?**
A: The V16 delivers up to 70 minutes of run time, which is enough to clean a whole house in one go without the disappointment of running out of battery partway through.
