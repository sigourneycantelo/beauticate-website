...
auto_faqs: true
faqs:
  - question: "Do you need council approval to build a backyard deck in NSW?"
    answer: "Local council regulations in NSW allow a deck of up to 20 square metres without a permit, subject to constraints such as floor height and roof height. Staying within those guidelines means you can build without paperwork."
  - question: "How do you get timber decking to look grey?"
    answer: "To achieve an aged grey timber look, choose a light timber such as Spotted Gum or Blackbutt, leach it by watering and drying daily for a week to remove natural colour tannins, use a timber bleach to lighten it, then apply a stain with a small amount of grey colour additive at half strength. Options used here include Intergrain Universal Timber Oil with a Coastal Grey additive and Cutek Extreme CD50 with Grey Mist Colourtone."
  - question: "What is the best way to get natural light into a covered deck without skylights?"
    answer: "Rather than installing skylights (which are expensive and require a roofing specialist for large versions), large glass panels alternated through the roof from top to bottom allow more light than skylights, are easier to install, and avoid the need for flashing on a corrugated roof."
  - question: "How long does it take to build a DIY deck?"
    answer: "This particular deck build took eight months of weekend work once the scope expanded from moving an existing deck to building an entirely custom indoor-outdoor living space with a roof, built-in BBQ area, and glass light panels."
---
...
He initially planned just to move the current deck to a new location, but after he found someone in the neighbourhood giving away several large timber posts, he got excited about the idea of making it more substantial.

<PullQuote>As with any good DIY enthusiast, he grossly underestimated the scope, budget and time required to complete said project.</PullQuote> He then felt like the old deck would be too small for the big thick posts, so decided to increase the size of the deck and to take advantage of the space available there. Our local council regulations allow up to 20 square metres without a permit, (with some other constraints – such as floor height and roof height), so we stuck to those guidelines to get it done without the paperwork.
