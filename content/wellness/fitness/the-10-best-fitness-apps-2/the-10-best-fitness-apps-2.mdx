...
**Q: What is the best free fitness app for all fitness levels?**
A: Nike Training Club (rated 4.8) offers professional trainer-led workouts across yoga, boxing, bodyweight training and endurance, ranging from 15 to 45 minutes for beginner to advanced levels. It also includes programs that choose your daily workout based on your personal goals, plus celebrity guest workouts.

**Q: What is the best fitness app if you have no gym equipment?**
A: Freeletics Bodyweight (rated 4.6) is designed for equipment-free training and includes a 2x2 mode that adapts workouts to fit in a two-by-two metre space, ideal for hotel rooms or small apartments. Workouts run between 5 and 30 minutes and are suitable for all fitness levels.

**Q: Is there a fitness app that donates to charity?**
A: Yes. Charity Miles (rated 4.6) converts every kilometre you walk, run or bike into a donation to one of over 40 charities, funded by corporate sponsors. Options include St Jude's Children's Hospital, the World Wildlife Fund and Habitat for Humanity.

**Q: What is the best fitness app for new mothers?**
A: Oh Baby! Mom and Baby Weekly Workout provides a free, tailored workout for each week post-delivery, using Pilates, yoga and strength training to safely rebuild the body after birth. The weekly videos are easy to follow and babies can join in on the sessions.