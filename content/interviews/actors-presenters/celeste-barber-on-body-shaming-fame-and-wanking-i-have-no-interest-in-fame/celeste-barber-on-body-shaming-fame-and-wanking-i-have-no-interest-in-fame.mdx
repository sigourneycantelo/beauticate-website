...
The BOOIE Base Face is the five-piece routine Celeste built to get herself out the door, and you can buy it as one bundle in our shop. Every BOOIE order comes with a Bloody Delicious illuminator free at the moment, while stocks last.
</EditorNote>
...
BOOIE is now stocked in the Beauticate Shop, and these are the pieces our founder Sigourney Cantelo has been wearing since the launch. Free shipping on all of it — and right now a Bloody Delicious illuminator free with any BOOIE order, while stocks last.
</EditorNote>
