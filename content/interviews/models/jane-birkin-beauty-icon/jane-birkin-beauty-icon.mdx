...
At an audition in London, a director found her self-deprecating humour refreshingly charming and so sent her to Paris to audition for a film called Slogan. Jane barely understood French at the time, instead relying on phonetics alone to guide her through the audition. Fresh from her divorce from John Barry, Jane sobbed uncontrollably throughout – yet despite the language barrier and tears, she got the role.[/vc_column_text][vc_single_image image="29848&#8243; img_size="full" alignment="center" css_animation="fadeIn"][vc_column_text css_animation="fadeIn"]
...
A testament to her enduring appeal, Jane is still gracing covers of magazines, having recently appeared on the cover of Vogue Paris, sharing the spotlight and guest editing the issue with her two daughters, Lou Doillon and Charlotte Gainsbourg.[/vc_column_text][vc_single_image image="29852&#8243; img_size="full" alignment="center" css_animation="fadeIn"][vc_column_text css_animation="fadeIn"]

IMAGE: INSTAGRAM @SMYTHSON

[/vc_column_text][vc_column_text css_animation="fadeIn"]*Story by Kristina Zhou*[/vc_column_text][/vc_column][/vc_row]
