...
**Q: What skincare range does Jasmine Lindsay use and recommend?**
A: Jasmine uses Rationale, a skincare system that starts with a DNA skin test to understand why your skin presents certain issues, then prescribes a suitable daily regime. She credits Rationale with helping her adopt a consistent skincare routine after sun damage started to appear in her thirties.

**Q: What does Jasmine Lindsay wear for her day-to-night makeup look?**
A: Jasmine uses Cle de Peau Radiant Fluid foundation for daytime and switches to NARS Sheer Glow for more coverage at night. She loves Charlotte Tilbury Filmstar Bronzer and Diorshow mascara for both, and adds Surratt eyeshadows in dark browns and charcoals to smoke up the eye for evening.

**Q: How does Jasmine Lindsay balance exercise with a busy schedule?**
A: Jasmine uses the Mindbody app to book classes that fit her schedule and mood each day. She does circuit classes and reformer Pilates during the week, long walks with friends on weekends, and always takes gym clothes to work so she can fit in a session no matter what the day brings.
