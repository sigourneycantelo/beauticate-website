...
**Q: What is the GO-TOs directory on Beauticate?**
A: The GO-TOs is an exclusive spa and salon directory of Australia's best beauty destinations. It was created to help readers find credible, well-reviewed spas and salons across the country.

**Q: How many spas and salons are featured in the GO-TOs directory?**
A: The directory launched with a shortlist of the top 100 spas and salons in Australia, with reviews being added progressively.

**Q: Why was the GO-TOs directory created?**
A: Reader surveys showed that 74% of Beauticate readers found it hard to get reliable information about spas and salons, and 88% said they would visit more often with better information available. The GO-TOs was built to fill that gap.

**Q: What information does each GO-TOs listing include?**
A: Each listing includes a detailed account of what it is like to visit, background on the founders and owners and a review written from firsthand experience.
