...
reading_time: 3
---
[vc_row][vc_column][vc_single_image image="33444&#8243; img_size="full"][vc_column_text]

IMAGE: INSTAGRAM @PROENZASCHOULER
...
**JM: **We drew a lot of inspiration from painters that we love, like Ellsworth Kelly and Carmen Herrera. The collection was built around a minimalist, abstract vision of colour. Blocks, instead of fades, of strong clean colour.[/vc_column_text][/vc_column][/vc_row][vc_row][vc_column][vc_single_image image="33447&#8243; img_size="full"][vc_column_text]

IMAGE: INSTAGRAM @LANCOMEOFFICIAL
...
[/vc_column_text][/vc_column][/vc_row][vc_row][vc_column][vc_single_image image="33449&#8243; img_size="full"][vc_column_text]
...
**JM:** They’re totally separate worlds, each with a different but connected purpose. Fundamentally, however, we took the same approach: we worked out what kind of a woman we thought would wear the collection, and started collecting images we felt drawn to. A lot of it came from paintings actually, mostly from the hard-edged minimalist painters of the 60’s. Carmen Herrera and Elsworth Kelly were two that we felt especially drawn to.[/vc_column_text][/vc_column][/vc_row][vc_row][vc_column][vc_column_text]*Story by Tess Schlink. The Lancôme x Proenza Schouler will be available from October.*[/vc_column_text][/vc_column][/vc_row]
