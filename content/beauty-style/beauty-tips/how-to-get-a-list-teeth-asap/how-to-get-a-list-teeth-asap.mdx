...
**Q: What is CEREC Omni Cam technology and how long does it take?**
A: It is a one-appointment ceramic tooth restoration system that uses digital impressions and computer-generated construction to create crowns and inlays while you wait. The whole process is completed in a single visit.

**Q: How does gum contouring work?**
A: It is a minimally invasive laser or hand procedure that removes excess gum tissue to expose more of the tooth and reduce a gummy smile. There is no downtime, though the area is tender for a few days afterwards.

**Q: Is teeth whitening suitable for sensitive teeth?**
A: The Philips Zoom White Speed system now has a control panel to adjust light intensity, making it suitable for sensitive patients by starting on a lower setting and increasing as tolerated.

**Q: What is sedation dentistry and who is it best suited for?**
A: Sedation dentistry allows patients to sleep through dental procedures. It is recommended for those with anxiety, previous bad experiences or anyone wanting to wake up to a completed smile transformation. Fasting beforehand and a lift home afterwards are required.
