...
---
We all know the single most sustainable way forward in beauty, as in life, is to buy nothing at all. Not a very *likely* way forward for most of us, though, so how can we at least buy less? ‘Shopping your stash’ has become one of the most laudable beauty trends in recent memory, and is all about using the skincare and makeup you already own instead of falling prey to the constant urge for something new. We're here to teach you how to do it in a way that's practical, safe (no using the expired SPF, thank you very much) and yes, even fun.
