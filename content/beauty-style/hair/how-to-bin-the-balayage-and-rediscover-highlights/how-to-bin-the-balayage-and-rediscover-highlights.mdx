...
**Q: What is Heath Grimmond's halo of illumination technique?**
A: It is a highlighting method where super-fine highlights are placed in a halo formation around the face to lift the complexion. The highlights are also hidden under the part, making them very low maintenance.

**Q: What products did Heath use on Sigourney's hair?**
A: He used Goldwell Silk Lift lightener for the highlights, Goldwell Colorance demi-permanent colour through the mid-lengths and ends, and Goldwell Topchic permanent colour at the roots for grey coverage.

**Q: What makes Goldwell Silk Lift different from standard lightener?**
A: It leaves hair in 25% better condition than standard powder lightener and includes an anti-yellow system that prevents the brassy fade that can occur with lightening.

**Q: Why did Sigourney want to try highlights over balayage?**
A: She wanted something as low maintenance as balayage but with a more polished, refined finish - and was inspired by the super-fine highlight look popular in the nineties.
