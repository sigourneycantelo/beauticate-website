...
featured_image_alt: "Q: How Can I Stop Chlorine Ruining My Hair?"
...
A gentle, nourishing shampoo such as Kevin Murphy’s HYDRATE_ME.WASH  is packed with antioxidants which gives the hair a healthy glow and stops the hair from losing any more moisture. Massage this onto your scalp post swim twice over and be sure not to scrub too hard. Follow this up with an appropriate conditioner or mask that preferably contains a balance of protein (which will strengthen your hair) and moisture (for that cosmetic suppleness we all long for after we have experienced the negative impact that chlorine has on hair). I adore Shu Uemura Ultimate Remedy Mask***,*** which not only smells so good you could eat it, but it will intensely repair, nourish & rebuild your hair without weighing it down. Leave it on your hair for up to 10 minutes wrapped in a hot towel or whilst in a steam room for best results."[/vc_column_text][/vc_column][/vc_row][vc_row][vc_column width="1/2&#8243;][vc_single_image image="7945&#8243; img_size="full" css_animation="fadeInUp"][vc_custom_heading text="KEVIN MURPHY’S HYDRATE_ME.WASH" font_container="tag:h3|font_size:10px|text_align:center" use_theme_fonts="yes" css_animation="fadeInUp" el_class="img-title" css=".vc_custom_1528181960282{padding-bottom: 20px !important;}"][/vc_column][vc_column width="1/2&#8243;][vc_single_image image="7947&#8243; img_size="full" css_animation="fadeInUp"][vc_custom_heading text="KERASTASE AQUA-SEAL" font_container="tag:h3|font_size:10px|text_align:center" use_theme_fonts="yes" css_animation="fadeInUp" el_class="img-title" css=".vc_custom_1528182110889{padding-bottom: 20px !important;}"][/vc_column][/vc_row][vc_row][vc_column width="1/2&#8243;][vc_single_image image="7950&#8243; img_size="full" css_animation="fadeInUp"][vc_custom_heading text="KERASTASE CC CREAM" font_container="tag:h3|font_size:10px|text_align:center" use_theme_fonts="yes" css_animation="fadeInUp" el_class="img-title" css=".vc_custom_1528182151401{padding-bottom: 20px !important;}"][/vc_column][vc_column width="1/2&#8243;][vc_single_image image="7951&#8243; img_size="full" css_animation="fadeInUp"][vc_custom_heading text="SHU UEMURA ULTIMATE REMEDY MASK" font_container="tag:h3|font_size:10px|text_align:center" use_theme_fonts="yes" css_animation="fadeInUp" el_class="img-title" css=".vc_custom_1528182185077{padding-bottom: 20px !important;}"][/vc_column][/vc_row][vc_row][vc_column][vc_column_text]
