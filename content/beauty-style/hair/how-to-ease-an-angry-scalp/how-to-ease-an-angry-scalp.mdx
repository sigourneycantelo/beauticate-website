...
**Q: Why does foamy shampoo irritate a sensitive scalp?**
A: Foamy shampoos contain surfactants, which over-strip the scalp and damage its natural barrier layer, leading to increased sensitivity. Dermatologist Dr Natasha Cook recommends choosing gentle, anti-inflammatory and hypoallergenic shampoos instead, and avoiding anything with SLS.

**Q: How often should you wash your hair if you have a sensitive scalp?**
A: Washing less frequently is key, as too much washing damages the scalp's outer protective barrier and triggers a "reactive oiliness pattern" where the scalp overproduces oil to compensate. Use a dry shampoo like Klorane Dry Shampoo with Oat Milk between washes to extend the time between cleansing.

**Q: What is the difference between dandruff, seborrheic dermatitis and eczema of the scalp?**
A: Dandruff is often simple sensitivity, while seborrheic dermatitis causes flaking around the scalp, brows and nose folds. Eczema can occur at the back of the neck and scalp area, and psoriasis commonly shows on both the scalp and on elbows and knees - a dermatologist can help identify which condition you have.

**Q: What oils can help soothe an inflamed scalp?**
A: Dr Natasha Cook recommends applying alpha keri oil, coconut oil or almond oil to the scalp overnight to neutralise and recondition the skin. For weekly maintenance, Dr Hauschka's Revitalising Hair and Scalp Tonic with neem leaf extract is a good option that can be used daily on fine hair.
