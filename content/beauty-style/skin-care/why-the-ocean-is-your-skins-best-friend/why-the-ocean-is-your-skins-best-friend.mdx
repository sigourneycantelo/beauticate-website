...
**Q: Why are marine ingredients good for skin?**
A: Marine ingredients like kelp, seaweed and algae contain high levels of trace minerals and elements that closely mimic the natural mineral composition of our blood plasma, making them highly compatible with our skin's own biology.

**Q: What is the key ingredient in La Mer skincare?**
A: La Mer uses sea kelp in fermented form as its key ingredient, combined with a mineral blend of sea water with the salt removed. The brand was founded by Dr Max Huber, who developed the formula to heal his own chemical facial burns.

**Q: What does algae do for the skin?**
A: Algae is a potent antioxidant that works to reduce inflammation and has been found to inhibit melanin production, which can brighten skin and reduce pigmentation over time.

**Q: What does a marine-inspired serum do when added to a skincare routine?**
A: A serum containing seawater delivers minerals and trace elements directly to the skin, gradually evening out skin tone and increasing luminosity when used consistently under moisturiser.