...
reading_time: 3
---
[vc_row][vc_column][vc_single_image image="37152&#8243; img_size="full" alignment="center" css_animation="fadeIn"][vc_column_text css_animation="fadeIn"]
...
Joanne explains that “chemical free” labelling is also a ruse. “All ingredients in a cosmetic product are scientifically considered to be chemicals – even essential oils, plant extracts and vitamins. So a ‘chemical free’ product does not exist.”[/vc_column_text][vc_column_text css_animation="fadeIn"]
...
Other common marketing terms to watch out for include ‘dermatologically’ and ‘scientifically tested’, which may quite simply mean that a product has undergone mandatory testing to ensure that it won’t irritate the skin. The words ‘research’ alongside the use of statistics to promote a product is another tactic to be wary of, Joanne warns. “Research can indicate that the product has undergone medical testing when in fact it may have only been used by a small group of select consumers, who have been asked some general questions about the product.”[/vc_column_text][vc_column_text css_animation="fadeIn"]

## YOUR SKIN TYPE MATTERS

Any ingredient, whether natural or synthetic, can irritate the skin, so being savvy about what you use – and what’s best for your skin type – is important. “The skin types which need to be more cautious of ingredients are people who tend to be reactive and/or sensitive, including people suffering from skin conditions such as rosacea,“ Joanne warns.[/vc_column_text][vc_column_text css_animation="fadeIn"]Story by Yadira Galarza Cauchi[/vc_column_text][/vc_column][/vc_row]
