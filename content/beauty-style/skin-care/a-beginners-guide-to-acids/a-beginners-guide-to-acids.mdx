...
<NumberedSection number="1" title="Lactic Acid is Your New Best Friend" />
...
<<<<<<< HEAD
<NumberedSection number="2" title="Know the Basics" />
...
<NumberedSection number="3" title="Look for Aminos to Soften the Blows" />
...
<NumberedSection number="4" title="Don't Be Scared to Mix it up a Little" />
...
<NumberedSection number="5" title="Go Slow and Low to Start" />
...
<NumberedSection number="6" title="Then Keep it up Daily" />
