...
**Q: How do you find the right foundation shade?**
A: Lloyd Simmonds recommends doing a patch test on the side of your lower cheek between your mouth and ear. Avoid your neck (which is often lighter from less sun exposure) and your hand (which tends to be darker).

**Q: Should you use a primer with YSL Fusion Ink Foundation?**
A: No. Lloyd does not recommend using a primer with Fusion Ink because the formula is naturally so long-wearing that a primer is unnecessary and can cause the foundation to ball if the products do not work together.

**Q: Where should you apply powder when wearing foundation?**
A: Apply powder only where you need to control shine - the centre of the face, chin and forehead. Never powder anywhere else, as this keeps the skin looking natural and extends the life of the foundation.

**Q: What is the most common foundation mistake women make?**
A: Wearing too much. Foundation is meant to blur imperfections, not create a blank canvas, so use only as much as you need and apply from the centre of the face outward.