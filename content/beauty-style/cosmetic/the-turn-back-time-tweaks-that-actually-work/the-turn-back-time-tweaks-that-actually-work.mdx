...
faqs:
  - question: "What's the most important anti-aging skincare ingredient?"
    answer: "According to cosmetic physician Dr. Joseph Hkeik says sunscreen is the number one essential. Prevention is always better than trying to reverse damage later, so a daily effective sunscreen should be the foundation of any anti-aging routine."
