 ...
 * that fires AddToCart for outbound "shop this" product links (tagged with
 * data-mp-* attributes by ProductTile), which keeps those cards server-rendered.
 *
...
export default function MetaPixel() {
  ...
  // Outbound "shop this" links → AddToCart.
  useEffect(() => {
    if (!META_PIXEL_ID) return
