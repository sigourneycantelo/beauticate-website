...
export default function AnnouncementBar({ message, href }: Props) {
  ...
  return (
    <div className="bg-charcoal text-cream text-center py-2 px-4 text-xs tracking-widest uppercase relative">
      <Link href={href} className="hover:text-gold transition-colors">{message}</Link>
      <button
